          ...
          <div className="col-sm-12 col-md-8 order-md-1">
            <div className="container">
              <div className="text-center mt-4 header">
                <h1>How Fast Can You Type in Ranbir's Type Master Game?</h1>
                <p className="lead">
        ...
        <footer className="small text-muted pt-5 pb-2 footer">
          <div className="footer-info text-center">
            <ul className="list-inline m-1">
              <li className="list-inline-item">Repo </li>
              <li className="list-inline-item"> - </li>
              <li className="list-inline-item">
                <a
                  href="https://github.com/sranbir392/Type_master"
                  target="_blank"
                  title="GitHub"
            ...
            <div className="copyright">
              ...
              by{" "}
              <a
                href="https://sranbir392.github.io/"
                title="Ranbir Singh"
                target="_blank"
                rel="noopener noreferrer"
              >
